# Form implementation generated from reading ui file 'admin_addActivity_window.ui'
#
...
class Ui_AdminAddActivityWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(140, 143, 428, 148))
...
"    }")
        ...
        self.label.setGeometry(QtCore.QRect(265, 70, 161, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Unique Activity Id:"))
        self.pushButton_back.setText(_translate("Form", "Back"))
        self.pushButton_5.setText(_translate("Form", "Admin Landing"))
        self.pushButton.setText(_translate("Form", "Add Question"))
        self.label.setText(_translate("Form", "Add Activity"))
