# Form implementation generated from reading ui file 'admin_addNewContentBlock_window.ui'
#
...
class Ui_AdminAddNewContentBlockWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(161, 133, 386, 289))
...
"    }")
        ...
        self.label.setGeometry(QtCore.QRect(190, 60, 321, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Content Block ID:"))
        self.pushButton.setText(_translate("Form", "Add Text"))
        self.pushButton_2.setText(_translate("Form", "Add Picture"))
        self.pushButton_3.setText(_translate("Form", "Add Activity"))
        self.pushButton_4.setText(_translate("Form", "Admin Landing"))
        self.pushButton_back.setText(_translate("Form", "Back"))
        self.label.setText(_translate("Form", "Add New Content Block"))
