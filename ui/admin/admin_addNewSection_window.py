# Form implementation generated from reading ui file 'admin_addNewSection_window.ui'
#
...
class Ui_AdminAddNewSectionWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(240, 67, 231, 41))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(120, 140, 455, 148))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Add New Section"))
        self.label_4.setText(_translate("Form", "Section Number:"))
        self.label_5.setText(_translate("Form", "Section Title:"))
        self.pushButton_back.setText(_translate("Form", "Back"))
        self.pushButton_2.setText(_translate("Form", "Admin Landing"))
        self.pushButton.setText(_translate("Form", "Add New Content Block"))
