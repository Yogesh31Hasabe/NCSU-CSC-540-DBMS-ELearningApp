# Form implementation generated from reading ui file 'admin_createAETextbook_window.ui'
#
...
class Ui_AdminCreateAETextbookWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(230, 60, 261, 41))
        font = QtGui.QFont()
        ...
        self.widget.setGeometry(QtCore.QRect(170, 133, 386, 148))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Create a E-textbook"))
        self.label_4.setText(_translate("Form", "Title of new E-textbook:"))
        self.label_5.setText(_translate("Form", "Unique E-textbook Id:"))
