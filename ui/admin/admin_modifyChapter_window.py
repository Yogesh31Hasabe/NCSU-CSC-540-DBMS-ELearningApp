# Form implementation generated from reading ui file '.\ui\admin\admin_modifyChapter_window.ui'
#
...
class Ui_AdminModifyChapterWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(170, 130, 386, 241))
...
"    }")
        ...
        self.label.setGeometry(QtCore.QRect(254, 57, 211, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "Unique Chapter ID:"))
        self.pushButton.setText(_translate("Form", "Add New Section"))
        self.pushButton_2.setText(_translate("Form", "Modify Section"))
        self.pushButton_3.setText(_translate("Form", "Admin Landing"))
        self.pushButton_back.setText(_translate("Form", "Back"))
        self.label.setText(_translate("Form", "Modify Chapter"))
