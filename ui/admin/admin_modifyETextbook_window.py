# Form implementation generated from reading ui file 'admin_modifyETextbook_window.ui'
#
...
class Ui_AdminModifyETextbookWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(239, 60, 261, 41))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(170, 133, 386, 241))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Modify E-textbook"))
        self.label_4.setText(_translate("Form", "Unique E-textbook ID:"))
        self.pushButton.setText(_translate("Form", "Add New Chapter"))
        self.pushButton_2.setText(_translate("Form", "Modify Chapter"))
        self.pushButton_3.setText(_translate("Form", "Admin Landing"))
