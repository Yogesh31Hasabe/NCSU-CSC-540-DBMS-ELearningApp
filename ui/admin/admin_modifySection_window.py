# Form implementation generated from reading ui file 'admin_modifySection.ui'
#
...
class Ui_AdminSectionWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(250, 60, 201, 41))
        font = QtGui.QFont()
        ...
        self.widget.setGeometry(QtCore.QRect(50, 130, 624, 199))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Modify Section"))
        self.label_4.setText(_translate("Form", "Unique E-textbook ID:"))
        self.label_5.setText(_translate("Form", "Chapter ID:"))
        self.label_6.setText(_translate("Form", "Section Number:"))
        self.pushButton_back.setText(_translate("Form", "Back"))
        self.pushButton_2.setText(_translate("Form", "Admin Landing"))
        self.pushButton_3.setText(_translate("Form", "Modify Content Block"))
        self.pushButton.setText(_translate("Form", "Add Content Block"))
