...
################################################################################
## Form generated from reading UI file 'admin_addActivity_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QRect(140, 143, 428, 148))
...
"    }")
        ...
        self.label.setGeometry(QRect(265, 70, 161, 41))
        font1 = QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(QCoreApplication.translate("Form", u"Unique Activity Id:", None))
        self.pushButton_back.setText(QCoreApplication.translate("Form", u"Back", None))
        self.pushButton_5.setText(QCoreApplication.translate("Form", u"Admin Landing", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"Add Question", None))
        self.label.setText(QCoreApplication.translate("Form", u"Add Activity", None))
    # retranslateUi
