...
################################################################################
## Form generated from reading UI file 'admin_addNewChapter_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QRect(245, 60, 241, 41))
        font = QFont()
        ...
        self.layoutWidget.setGeometry(QRect(170, 133, 428, 148))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Add New Chapter", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"Unique Chapter ID:", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"Chapter Title:", None))
