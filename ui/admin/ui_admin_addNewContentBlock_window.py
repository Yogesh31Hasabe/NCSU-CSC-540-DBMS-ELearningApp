...
################################################################################
## Form generated from reading UI file 'admin_addNewContentBlock_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QRect(161, 133, 386, 289))
...
"    }")
        ...
        self.label.setGeometry(QRect(190, 60, 321, 41))
        font1 = QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(QCoreApplication.translate("Form", u"Content Block ID:", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"Add Text", None))
        self.pushButton_2.setText(QCoreApplication.translate("Form", u"Add Picture", None))
        self.pushButton_3.setText(QCoreApplication.translate("Form", u"Add Activity", None))
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Add New Content Block", None))
    # retranslateUi
