...
################################################################################
## Form generated from reading UI file 'admin_addNewSection_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QRect(240, 67, 231, 41))
        font = QFont()
        ...
        self.layoutWidget.setGeometry(QRect(120, 140, 455, 148))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Add New Section", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"Section Number:", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"Section Title:", None))
        ...
        self.pushButton.setText(QCoreApplication.translate("Form", u"Add New Content Block", None))
    # retranslateUi
