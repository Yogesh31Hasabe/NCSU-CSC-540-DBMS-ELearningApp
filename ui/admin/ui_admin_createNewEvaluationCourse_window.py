...
################################################################################
## Form generated from reading UI file 'admin_createNewEvaluationCourse_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QRect(20, 130, 338, 200))
...
"    }")
        ...
        self.label.setGeometry(QRect(150, 50, 421, 41))
        font1 = QFont()
        ...
        self.layoutWidget_2.setGeometry(QRect(360, 130, 338, 200))
...
"    }")
        ...
        self.widget.setGeometry(QRect(205, 360, 308, 44))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Create A New Evaluation Course", None))
        self.label_9.setText(QCoreApplication.translate("Form", u"Faculty ID:", None))
