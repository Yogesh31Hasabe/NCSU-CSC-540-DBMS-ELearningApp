...
################################################################################
## Form generated from reading UI file 'admin_modifyChapter_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QRect(170, 130, 386, 241))
...
"    }")
        ...
        self.label.setGeometry(QRect(254, 57, 211, 41))
        font1 = QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(QCoreApplication.translate("Form", u"Add New Section", None))
        self.pushButton_2.setText(QCoreApplication.translate("Form", u"Modify Section", None))
        self.pushButton_3.setText(QCoreApplication.translate("Form", u"Admin Landing", None))
        self.pushButton_back.setText(QCoreApplication.translate("Form", u"Back", None))
        self.label.setText(QCoreApplication.translate("Form", u"Modify Chapter", None))
    # retranslateUi
