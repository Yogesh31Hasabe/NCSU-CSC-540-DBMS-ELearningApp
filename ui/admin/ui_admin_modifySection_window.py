...
################################################################################
## Form generated from reading UI file 'admin_modifySection_window.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QRect(250, 60, 201, 41))
        font = QFont()
        ...
        self.widget.setGeometry(QRect(50, 130, 624, 199))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Modify Section", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"Unique E-textbook ID:", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"Chapter ID:", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"Section Number:", None))
        ...
        self.pushButton_3.setText(QCoreApplication.translate("Form", u"Modify Content Block", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"Add Content Block", None))
    # retranslateUi
