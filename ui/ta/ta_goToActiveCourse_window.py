# Form implementation generated from reading ui file 'ta_goToActiveCourse_window.ui'
#
...
class Ui_TaGoToActiveCourseWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.layoutWidget = QtWidgets.QWidget(parent=Form)
        self.layoutWidget.setGeometry(QtCore.QRect(161, 133, 386, 307))
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_2.setText(_translate("Form", "Add New Chapter"))
        self.pushButton_3.setText(_translate("Form", "Modify Chapters"))
        self.pushButton_back.setText(_translate("Form", "Back"))
        self.label.setText(_translate("Form", "TA - Go to Active Course"))
