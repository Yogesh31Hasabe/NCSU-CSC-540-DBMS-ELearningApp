# Form implementation generated from reading ui file 'ta_login_window.ui'
#
...
class Ui_TaLoginWindow(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(720, 480)
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(280, 50, 120, 41))
        font = QtGui.QFont()
...
"    }")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "TA Login"))
